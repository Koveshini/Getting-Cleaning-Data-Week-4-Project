...
This document is a codebook that provides descriptions of the variables, data and all the transformations that I performed on the data. 

## The Data Source

### Source Data
Data: https://d396qusza40orc.cloudfront.net/getdata%2FUCI%20HAR%20Dataset.zip
Description of the data set from the source: http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones
...
### Create R script called run_analysis.R that meets the following requirements 
